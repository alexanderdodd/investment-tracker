...
export async function GET(request: Request) {
  ...
  return NextResponse.json({
    message: `Reports: ${reportOk}/${reportOk + reportFail}. Leaders: ${leaderOk}/${leaderOk + leaderFail}. Value: ${valueOk}/${valueOk + valueFail}. Analyses: ${analysisOk}/${analysisOk + analysisFail}.`,
