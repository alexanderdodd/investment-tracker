...
export const WATCHLIST_STATUSES = [
  ...
  { value: "to-research", label: "To research", dot: "bg-blue-500", chip: "bg-blue-500/10 text-blue-600 dark:text-blue-400", active: "border-blue-500/60 bg-blue-500/15 text-blue-600 dark:text-blue-400" },
  { value: "to-buy", label: "To buy", dot: "bg-emerald-500", chip: "bg-emerald-500/10 text-emerald-600 dark:text-emerald-400", active: "border-emerald-500/60 bg-emerald-500/15 text-emerald-600 dark:text-emerald-400" },
...
export function StatusPicker({
  ...
  return (
    <span className={`relative inline-flex items-center gap-1.5 rounded-full px-2.5 py-1 text-xs font-medium ${meta.chip}`}>
